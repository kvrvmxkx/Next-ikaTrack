...
const items: MenuItem[] = [
  {
    ...
    roles: [Roles.SUPER_ADMIN, Roles.ADMIN, Roles.AGENT_MALI, Roles.AGENT_CI, Roles.AGENT_CHINE],
  },
  {
    title: "Colis",
    url: "/colis",
    icon: Package,
    roles: [Roles.SUPER_ADMIN, Roles.ADMIN, Roles.AGENT_CHINE, Roles.AGENT_MALI, Roles.AGENT_CI],
  },
  {
    title: "Groupages",
    url: "/colis/groupe",
  ...
  },
  {
    ...
    url: "/caisse",
    icon: Vault,
    roles: [Roles.SUPER_ADMIN, Roles.ADMIN, Roles.AGENT_MALI, Roles.AGENT_CI],
  },
  {
    title: "WhatsApp",
    url: "/whatsapp",
